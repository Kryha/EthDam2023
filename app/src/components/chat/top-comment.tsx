		...
		>
			...
			>
				...
				<Stack direction="row" spacing={2}>
					<IconButton size="small" sx={{ bgcolor: "primary.main" }} onClick={() => callUpvote(messageId, 1)}>
						<North fontSize="small" color="secondary" />
					</IconButton>
					<IconButton size="small" sx={{ bgcolor: "primary.main" }} onClick={() => callDownvote(messageId, 1)}>
